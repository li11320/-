...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: '4b4effc3c6bae550faab6ee6b7dbae6b',
    ...
    // 天气预报（展示未来N天，最多7天）, 填 0 则不使用，按需关闭不使用的功能可以提高运行速度
    weatherforecast: 3,
  ...
  USERS: [
    {
      ...
      id: 'olDYP66ilB68xh3SgURjA3NmJwQ8',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'QIsJflobgTFVAv43IWnt5w1QancgRLC20MrzFdVaJOY',
      // 所在省份或城市，也可以不填
      province: '北京',
      // 所在城市或县区
      city: '朝阳区',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2006', date: '07-17',
        },
        {
        ...
        {
          type: '生日', name: '李四', year: '2006', date: '07-17',
        },
        {
