  ...
  USERS: [
    {
      ...
      id: 'olDYP6zOFYy18vktlDA0JFOmWUyM',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'YoP5AxB7JigBEqrUD_ycKzU1c5YRTtz__pLgryrETgg',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '锦宝宝~', year: '2006', date: '06-29',
        },
        {
...
const USER_CONFIG = {
  ...
  CALLBACK_TEMPLATE_ID: '1mFES4UHbt3J586TaoE6977xlrge9vcsjCeBpYBBFHw',
